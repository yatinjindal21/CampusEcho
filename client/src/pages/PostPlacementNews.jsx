...
export default function PostPlacementNews() {
  ...
  const submit = async e => {
    ...
    data.append('category', 'placement');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-100 px-2">
      <div className="w-full max-w-2xl bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-12 border border-gray-100">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Post Placement News</h1>
          <p className="text-gray-500 text-base text-center max-w-lg">Share the latest placement opportunities and updates with the community.</p>
        </div>
        <form onSubmit={submit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                value={form.tags}
                onChange={handleChange}
                placeholder="e.g. placement, drive, company"
                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 transition bg-white text-gray-800"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white text-gray-800 h-32 resize-none"
              required
            />
          </div>
          <button
